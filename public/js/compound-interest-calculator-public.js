	...
	line = new Chart(document.getElementById("lineChart"), {
			...
			datasets: [
				{
					...
					borderColor: cicw_front_object.cicw_primary_color,
					data: []
				},
				{
					type: "line",
					label: "Yearly Interest paid",
					borderColor: cicw_front_object.cicw_secondary_color,
					data: []
				}
			],
			labels: []
		...
		options: {
			...
			scales: {
				x: {
					title: {
						color: cicw_front_object.cicw_tertiary_color,
						display: true,
						text: "Years Passed"
					}
				},
			...
			datasets: [
				{
					...
					data: [0, 0],
					backgroundColor: [ cicw_front_object.cicw_primary_color, cicw_front_object.cicw_secondary_color],
					hoverOffset: 4
				}
			]
		},
